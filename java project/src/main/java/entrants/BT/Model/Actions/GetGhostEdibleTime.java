...
/** ModelAction class created from MMPM action GetGhostEdibleTime. */
public class GetGhostEdibleTime extends jbt.model.task.leaf.action.ModelAction {
	/**
	...
	/**
	 * Constructor. Constructs an instance of GetGhostEdibleTime.
	 * 
	 * @param ghost
	 ...
	 *            retrieved from.
	 */
	public GetGhostEdibleTime(jbt.model.core.ModelTask guard,
	...
	/**
	 * Returns a entrants.BT.Execution.Actions.GetGhostEdibleTime task that is
	 * able to run this task.
	 */
	public jbt.execution.core.ExecutionTask createExecutor(
			jbt.execution.core.BTExecutor executor,
			jbt.execution.core.ExecutionTask parent) {
		return new entrants.BT.Execution.Actions.GetGhostEdibleTime(this,
