...
/** ModelCondition class created from MMPM condition WasGhostEaten. */
public class WasGhostEaten extends jbt.model.task.leaf.condition.ModelCondition {
	/**
	...
	/**
	 * Constructor. Constructs an instance of WasGhostEaten.
	 * 
	 * @param ghost
	 ...
	 *            retrieved from.
	 */
	public WasGhostEaten(jbt.model.core.ModelTask guard,
	...
	/**
	 * Returns a entrants.BT.Execution.Conditions.WasGhostEaten task that is
	 * able to run this task.
	 */
	public jbt.execution.core.ExecutionTask createExecutor(
			jbt.execution.core.BTExecutor executor,
			jbt.execution.core.ExecutionTask parent) {
		return new entrants.BT.Execution.Conditions.WasGhostEaten(this,
