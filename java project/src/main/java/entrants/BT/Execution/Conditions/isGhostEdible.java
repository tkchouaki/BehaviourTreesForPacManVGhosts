...
/** ExecutionCondition class created from MMPM condition isGhostEdible. */
public class isGhostEdible extends
	...
	/**
	 * Constructor. Constructs an instance of isGhostEdible that is able to run
	 * a entrants.BT.Model.Conditions.isGhostEdible.
	 * 
	 * @param ghost
	 ...
	 *            retrieved from.
	 */
	public isGhostEdible(entrants.BT.Model.Conditions.isGhostEdible modelTask,
	...
	protected jbt.execution.core.ExecutionTask.Status internalTick() {
		...
		if(game.isGhostEdible(Constants.GHOST.valueOf(getGhost()))){
