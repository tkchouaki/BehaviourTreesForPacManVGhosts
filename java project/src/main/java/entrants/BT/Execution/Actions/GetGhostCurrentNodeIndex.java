...
/** ExecutionAction class created from MMPM action GetGhostCurrentNodeIndex. */
public class GetGhostCurrentNodeIndex extends
	...
	/**
	 * Constructor. Constructs an instance of GetGhostCurrentNodeIndex that is
	 * able to run a entrants.BT.Model.Actions.GetGhostCurrentNodeIndex.
	 * 
	 * @param ghost
	 ...
	 *            retrieved from.
	 */
	public GetGhostCurrentNodeIndex(
			entrants.BT.Model.Actions.GetGhostCurrentNodeIndex modelTask,
