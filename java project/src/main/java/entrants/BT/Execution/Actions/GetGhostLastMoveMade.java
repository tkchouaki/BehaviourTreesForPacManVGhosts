...
/** ExecutionAction class created from MMPM action GetGhostLastMoveMade. */
public class GetGhostLastMoveMade extends
	...
	/**
	 * Constructor. Constructs an instance of GetGhostLastMoveMade that is able
	 * to run a entrants.BT.Model.Actions.GetGhostLastMoveMade.
	 * 
	 * @param ghost
	 ...
	 *            retrieved from.
	 */
	public GetGhostLastMoveMade(
			entrants.BT.Model.Actions.GetGhostLastMoveMade modelTask,
