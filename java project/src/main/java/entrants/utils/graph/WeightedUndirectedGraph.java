 ...
 *
 * @param <N> The class that represents the nodes of the graph, this class should implement the Node interface
 * @param <E> The class that represents the Edges of the graph, this class should implement the WeightedEdgeInterface
 */
